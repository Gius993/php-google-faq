<?php
    $faq = [
        [
            'title' => 'Come state implementando la recente decisione della Corte di giustizia delloblio?',
...
<header>
	...
	<main class="main-container">
		<?php foreach ($faq as $faqGoogle){ ?>
		<div class="faq">
			<h2><?php echo $faqGoogle ['title']?></h2>
			<p><?php echo $faqGoogle ['text']?></p>
		</div>
		<?php } ?>
	</main>
